...
For the convenience of sample, we will use (Isle of Wight)[https://en.wikipedia.org/wiki/Isle_of_Wight] case, with 384 km2. See [Other examples] below.
...
In this case, there are 1.6 times more segments than the original network.


`r # round(nrow(iow_network_segments)/nrow(iow_network_clean),2)`
...
Half of the road segments in Isle of Wight have a gradient bellow 3.1%.
