...
Imagine that we want to go from from the Santa Catarina area in the East of the map to the Castelo de São Jorge in the West.
...
```{r, echo=FALSE}
lisbon_route_xyz = lisbon_route_xyz_mapbox
```
...
The following commands calculate the elevations of a route in Leeds (not evaluated).
