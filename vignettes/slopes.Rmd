...
```{r}
# Use the recommended green-to-red palette and matching break thresholds

plot_slope(sf_linestring_xyz_local, pal = slope_colors, brks = slope_breaks)
```
...
plot(st_geometry(lisbon_route_segments_xyz),
  col = slope_colors[cut(lisbon_route_segments_xyz$slope, breaks = slope_breaks,
...
plot(st_geometry(lisbon_route_100m_xyz),
  col = slope_colors[cut(lisbon_route_100m_xyz$slope, breaks = slope_breaks,
    labels = FALSE, include.lowest = TRUE)],
