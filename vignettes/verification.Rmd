...
An input dataset, comprising a 3D linestring recorded using a dual frequency GNSS receiver (a [Leica 1200](https://gef.nerc.ac.uk/equipment/gnss/1200/1200_overview.php)) with a vertical accuracy of 20 mm
...
```{r, eval=FALSE}
unzip("vignettes/3DGRT_AXIS_EPSG25830_v2.zip")
