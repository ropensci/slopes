...
2. `plot_slope()`: Plots the slope profile associated with a linestring
3. `map_slope()` (to be created)
4. `slope_z_value()`: returns the Z component of coordinates
...
Uses ceramic / mapbox api


#### other sources for elevation 
