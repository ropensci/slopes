...
## Plot segment example

---

### find slope with native function
...
-   Include functions to extract digital elevation models for the assessed area?
-   Improve `plot_3d()` visualization
-   Add other elevation sources using api keys?
-   ...
