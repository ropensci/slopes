...
This outlines how to propose a change to slopes. For more detailed info
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("ropensci/slopes", fork = TRUE)`.
...
of Conduct](https://docs.ropensci.org/slopes/CODE_OF_CONDUCT.md). By
