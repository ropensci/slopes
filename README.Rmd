...
See the [`intro-to-slopes` vignette](https://itsleeds.github.io/slopes/articles/intro-to-slopes.html) for details on fields using slope data and the need for this package.
...
slopes package is released under the [Contributor Code of Conduct](https://devguide.ropensci.org/collaboration.html#coc-file) of rOpenSci. By contributing to this project, you agree to abide by its terms.
