...
Trajectories ================ 27 September 2021
...
which adds a third ‘Z’ coordinate value for each vertex defining
LINESTRING objects, and
[`slope_xyz()`](https://docs.ropensci.org/slopes/reference/slope_xyz.md)
which calculates slopes for each linear feature in a simple features
object.
